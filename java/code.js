...
alert(num1+' books, Keep going!'+'so you prefer read '+numbook+' type.')
...
alert(num1+' books, Keep going!'+'so you prefer read '+numbook+' type.'+name1+' your favourite book');
...
alert (num1+' books, Keep going!'+'so you prefer read '+numbook+' type.'+name1+' your favourite book'+'you like to '+type+' books,and this is nice way');
